...
var gen = generator()
    .addMappings('foo.js 1', [{ original: { line: 2, column: 3 } , generated: { line: 5, column: 10 } }], { line: 5 })
    .addGeneratedMappings('bar.js 1', 'var a = 2;\nconsole.log(a)', { line: 23, column: 22 })
...
test('to map file comment', function (t) {
  t.equal(convert.generateMapFileComment('index.js 1.map'), '//# sourceMappingURL=index.js 1.map');
...
test('remove map file comments', function (t) {
  ...
  , fileMap1 = '//# sourceMappingURL=foo.js 1.map'
  , fileMap2 = '/*# sourceMappingURL=foo.js 1.map */';
...
test('getting properties', function (t) {
  ...
  t.deepEqual(sm.getProperty('sources'), ['foo.js 1', 'bar.js 1'], 'gets sources')
  t.end()
})
