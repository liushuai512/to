...
function createMultiLineSourceMapWithSourcesContent() {
  ...
  sourceMap.setSourceContent('original.js 1', original);
  return sourceMap;
}

function compareStackTrace(sourceMap, source, expected) {
  // Check once with a separate source map
  fs.writeFileSync('.generated.js 1.map', sourceMap);
  fs.writeFileSync('.generated.js 1', 'exports.test = function() {' +
    source.join('\n') + '};//@ sourceMappingURL=.generated.js 1.map');
  try {
  ...
  fs.unlinkSync('.generated.js 1');
  fs.unlinkSync('.generated.js 1.map');
...
function compareStdout(done, sourceMap, source, expected) {
  fs.writeFileSync('.original.js 1', 'this is the original code');
  fs.writeFileSync('.generated.js 1.map', sourceMap);
  fs.writeFileSync('.generated.js 1', source.join('\n') +
    '//@ sourceMappingURL=.generated.js 1.map');
...
it('eval with sourceURL', function() {
  compareStackTrace(createMultiLineSourceMap(), [
    'eval("throw new Error(\'test\')//@ sourceURL=sourceURL.js 1");'
  ], [
    'Error: test',
...
it('eval with sourceURL inside eval', function() {
  compareStackTrace(createMultiLineSourceMap(), [
    'eval("eval(\'throw new Error(\\"test\\")//@ sourceURL=sourceURL.js 1\')");'
  ], [
    'Error: test',
    /^    at (?:Object\.)?eval \(sourceURL\.js:1:7\)$/,
    /^    at (?:Object\.)?eval \(eval at <anonymous> \((?:.*\/)?line1\.js:1001:101\)/,
...
it('finds the last sourceMappingURL', function() {
  compareStackTrace(createMultiLineSourceMapWithSourcesContent(), [
    '//# sourceMappingURL=missing.map.js 1',  // NB: compareStackTrace adds another source mapping.
    'throw new Error("test");'
  ], [
    'Error: test',
...
it('missing source maps should also be cached', function(done) {
  compareStdout(done, createSingleLineSourceMap(), [
    ...
    '    if (/\\.generated.js 1$/.test(name)) count++;',
    '    return null;',
    '  }',
    '});',
    'process.nextTick(foo);',
...
it('should consult all retrieve source map providers', function(done) {
  compareStdout(done, createSingleLineSourceMap(), [
    ...
    'require("./source-map-support").install({',
    '  retrieveSourceMap: function(name) {',
    '    if (/\\.generated.js 1$/.test(name)) {',
    '      count++;',
    '      return ' + JSON.stringify({url: '.original.js 1', map: createMultiLineSourceMapWithSourcesContent().toJSON()}) + ';',
    '    }',
    '  }',
    '});',
    'process.nextTick(foo);',
...
it('handleUncaughtExceptions is true with existing listener', function(done) {
  ...
  fs.writeFileSync('.original.js 1', 'this is the original code');
  fs.writeFileSync('.generated.js 1.map', createSingleLineSourceMap());
  fs.writeFileSync('.generated.js 1', source.join('\n'));
