...
function p(h,c){if(!h)throw Error(c||"Failed assertion");}var J=n("base64-js 1"),I=n("ieee754");t.Buffer=e;t.SlowBuffer=e;t.INSPECT_MAX_BYTES=50;e.poolSize=8192;e._useTypedArrays=function(){try{var h=new ArrayBuffer(0),c=new Uint8Array(h);c.foo=function(){return 42};return 42===c.foo()&&"function"===typeof c.subarray}catch(a){return!1}}();e.isEncoding=function(h){switch(String(h).toLowerCase()){case "hex":case "utf8":case "utf-8":case "ascii":case "binary":case "base64":case "raw":case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":return!0;
...
return d.join("/")};t.sep="/";t.delimiter=":";t.dirname=function(b){var f=m.exec(b).slice(1);b=f[0];f=f[1];if(!b&&!f)return".";f&&(f=f.substr(0,f.length-1));return b+f};t.basename=function(b,f){var e=m.exec(b).slice(1)[2];f&&e.substr(-1*f.length)===f&&(e=e.substr(0,e.length-f.length));return e};t.extname=function(b){return m.exec(b).slice(1)[3]};var g="b"==="ab".substr(-1)?function(b,f,e){return b.substr(f,e)}:function(b,f,e){0>f&&(f=b.length+f);return b.substr(f,e)}}).call(this,n("node_modules/process/browser.js 1"))},
...
(b=a.retrieveSourceMap);c&&"object"===typeof e&&null!==e&&"function"===typeof e.on&&A()}}}).call(this,n("node_modules/process/browser.js 1"),n("buffer").Buffer)},{"node_modules/process/browser.js":8,buffer:5,fs:4,path:7,"source-map":9}]},{},[1]);return K});
