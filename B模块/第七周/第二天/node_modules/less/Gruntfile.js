...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        shell: {
            ...
            benchmark: {
                command: 'node benchmark/.babelrc.js'
            },
            "sourcemap-test": {
                command: [
        ...
        jasmine: {
            ...
            postProcessorPlugin: {
                ...
                options: {
                    helpers: ['test/plugins/postprocess/.babelrc.js','test/browser/runner-postProcessorPlugin-options.js'],
            ...
            preProcessorPlugin: {
                ...
                options: {
                    helpers: ['test/plugins/preprocess/.babelrc.js','test/browser/runner-preProcessorPlugin-options.js'],
            ...
            visitorPlugin: {
                ...
                options: {
                    helpers: ['test/plugins/visitor/.babelrc.js','test/browser/runner-VisitorPlugin-options.js'],
            ...
            filemanagerPlugin: {
                ...
                options: {
                    helpers: ['test/plugins/filemanager/.babelrc.js','test/browser/runner-filemanagerPlugin-options.js'],
